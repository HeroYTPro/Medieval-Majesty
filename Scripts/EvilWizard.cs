...
public class EvilWizard : MonoBehaviour
{
    ...
    public bool _hasRangeTaret = false;
    public bool HasRangeTarget
    {
        get { return _hasRangeTaret; }
        private set
        {
            _hasRangeTaret = value;
            animator.SetBool("hasRangeTarget", value);
        }
    }
    ...
    void Update()
    {
        ...
        HasRangeTarget = rangeAttackZone.detectedColliders.Count > 0;
    ...
    private void FixedUpdate()
    {
        ...
        if (reversal.detectedColliders.Count > 0)
        {
            FlipDirection();
        }
    }
